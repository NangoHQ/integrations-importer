...
export const NangoFlows = [
  ...
  {
    "providerConfigKey": "notion-db",
    "syncs": [],
    "actions": [
      {
        "name": "content-to-db",
        "type": "action",
        "description": "Fetches a page of data in Notion to then create a database from that content",
        "version": "",
        "scopes": [],
        "input": "ContentToDb",
        "output": [
      ...
      },
      {
        "name": "check-for-new-providers-and-create",
        "type": "action",
        "description": "Grab all the new providers from the sync, check for updated ones \nand create them as a Notion entry in a database",
        "version": "",
        "scopes": [],
        "input": "LastSyncDate",
        "output": null,
    ...
    "actions": [
      {
        ...
        "type": "action",
        "description": "Given a notion database create an issue in Linear",
        "version": "",
        "scopes": [],
